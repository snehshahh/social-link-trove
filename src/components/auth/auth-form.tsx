    ...
    <Card className="w-full max-w-md bg-black border-white/20">
      <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as "login" | "signup")} className="w-full">
          ...
          <CardContent>
            <Form {...loginForm}>
              <form onSubmit={loginForm.handleSubmit(onLoginSubmit)} className="space-y-4">
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input placeholder="you@example.com" className="pl-10 bg-black/50 border-white/20 text-white placeholder:text-white/30" {...field} />
                        </div>
                      </FormControl>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input type="password" placeholder="••••••" className="pl-10 bg-black/50 border-white/20 text-white placeholder:text-white/30" {...field} />
                        </div>
                      </FormControl>
                      <FormMessage className="text-yellow-400" />
                    </FormItem>
                ...
                />
                <Button type="submit" className="w-full bg-white text-black hover:bg-white/90" disabled={isLoggingIn}>
                  {isLoggingIn ? (
                    <>
          ...
          <CardContent>
            <Form {...signupForm}>
              <form onSubmit={signupForm.handleSubmit(onSignupSubmit)} className="space-y-4">
                ...
                />
                <Button type="submit" className="w-full bg-white text-black hover:bg-white/90" disabled={isSigningUp}>
                  {isSigningUp ? (
                    <>
                      <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                      Creating account...
        ...
        <CardFooter className="flex flex-col space-y-4 pt-4">
          ...
          <Button variant="outline" className="w-full bg-black border-white/20 text-white hover:bg-white hover:text-black" onClick={handleGoogleAuth}>
