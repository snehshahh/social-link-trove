          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="hidden md:flex flex-1 justify-center">
              <div className="flex flex-col items-center">
                <span className="-rotate-90 text-5xl md:text-7xl font-bold tracking-tighter text-white hover:text-yellow-400 transition-colors">
                  linker's db
                </span>
              </div>
            </div>
            ...
            <div className="hidden md:block w-px h-64 bg-white/10 mx-5"></div>

            {/* Right: Hero Text and Buttons */}
            <div className="flex-1 px-4 md:px-0 max-w-3xl mx-auto text-center md:text-left">
              <h1 className="text-3xl md:text-6xl font-bold tracking-tighter leading-tight text-center text-white mb-4 hover:text-yellow-400 transition-colors">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-8 justify-center">
                <Button
                  ...
                  className="bg-black hover:bg-black/90 text-white border-2 border-yellow-400 px-8 py-6 text-base font-medium shadow-lg shadow-yellow-400/20 transition-all hover:shadow-yellow-400/30 hover:scale-105"
                >
                  Start For Free
                </Button>
              </div>
      ...
      <section className="py-16 md:py-32 bg-black relative overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-4">
            <div className="group bg-black/50 p-6 md:p-8 rounded-lg border border-yellow-400/10 hover:border-yellow-400/20 transition-all hover:transform hover:scale-105 backdrop-blur-sm">
