...
export default function Index() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-black text-white">
      ...
      <section className="flex min-h-screen items-center justify-center px-4 relative overflow-hidden bg-black animate-fade-in">
        {/* Background */}
        ...
        <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
          <img
            ...
            className="h-full w-full object-cover opacity-[0.03] transform scale-125 md:scale-110 animate-slide-in-up"
          />
        </div>
        ...
        <div className="container mx-auto z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            {/* Center: Vertical Line - Adjusted position */}
            <div className="hidden md:block w-px h-64 bg-white/10 mx-8 animate-scale-in"></div>

            {/* Right: Hero Text and Buttons */}
            <div className="flex-1 px-4 md:px-0 max-w-3xl mx-auto text-center md:text-left animate-slide-in-right">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-8 justify-center">
                <Button
                  ...
                  className="bg-black hover:bg-black/90 text-white border-2 border-white px-8 py-6 text-base font-medium shadow-lg transition-all hover:scale-105"
                >
                  Start For Free
                </Button>
              </div>
      ...
      <section className="py-16 md:py-32 bg-black relative overflow-hidden">
        ...
        <div className="container relative z-10">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-16 text-white animate-fade-in">Why Choose Linker's DB?</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-4">
            {/* Updated cards with white borders and stronger shadows on hover */}
            <div className="group bg-black/50 p-6 md:p-8 rounded-lg border border-white/10 hover:border-white/20 transition-all hover:transform hover:scale-105 backdrop-blur-sm hover:shadow-[0_0_30px_rgba(255,255,255,0.2)] animate-fade-in">
            ...
            <div className="group bg-black/50 p-6 md:p-8 rounded-lg border border-white/10 hover:border-white/20 transition-all hover:transform hover:scale-105 backdrop-blur-sm hover:shadow-[0_0_30px_rgba(255,255,255,0.2)] animate-fade-in delay-100">
              <div className="w-12 h-12 bg-white/10 rounded-full flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-white">
            ...
            <div className="group bg-black/50 p-6 md:p-8 rounded-lg border border-white/10 hover:border-white/20 transition-all hover:transform hover:scale-105 backdrop-blur-sm hover:shadow-[0_0_30px_rgba(255,255,255,0.2)] animate-fade-in delay-200">
              <div className="w-12 h-12 bg-white/10 rounded-full flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-white">
            ...
            <div className="group bg-black/50 p-6 md:p-8 rounded-lg border border-white/10 hover:border-white/20 transition-all hover:transform hover:scale-105 backdrop-blur-sm hover:shadow-[0_0_30px_rgba(255,255,255,0.2)] animate-fade-in delay-300">
              <div className="w-12 h-12 bg-white/10 rounded-full flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-white">
      ...
      <Dialog open={showAuthForm} onOpenChange={setShowAuthForm}>
        <DialogContent className="sm:max-w-md bg-black border border-yellow-400/20">
          <AuthForm />
        </DialogContent>
      </Dialog>
    </div>
